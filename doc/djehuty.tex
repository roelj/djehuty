...
.chapwrap p.noindent span.ectt-1200, .chapwrap p.ni span.e {
...
h3 span.ectt-1200, h3 span.e { display: inline-block; margin-right: 0.25em; }
...
.chapwrap .subsectionHead, .chapwrap .likesubsectionHead { padding: 5pt 10pt 5pt 10pt; background: #f6f6f6; border-top: solid 1pt #eee; border-bottom: solid 1pt #eee; }
.subsubsectionHead { padding: .25em 0em .25em .75em; font-size: 1em; background: #f6f6f6; }
...
.ectt-1200, .e { font-family: 'FiraMono', 'Lucida Console', Monaco, monospace; padding: 0pt; }
...
.sectionToc { display: inline-block; width: 100%; padding: .25em 0pt .25em 7pt; font-size 1.0em; }
...
.subsectionToc .ectt-1200, .subsectionToc .e { font-size: 0.9em; }
...
hr { border: none; }
div.figure p.noindent, div.figure p.ni { display: none; }
div.figure div.center p.noindent, div.figure div.center p.ni { display: block; }
...
.td11 { white-space:normal; text-align:left; }
.tr11 { vertical-align:baseline; }
.bl { color #000; }
.rd { color: #BF0040; }
.pr { color: #800080; }
.gr { color: #666; }
...
<div class="center">
  ...
  <h2>A data and software repository system</h2>
  <p>\end{html}%
...
\begin{titlepage}
  \begin{center}
    ...
    \vspace*{\fill}
    { \Huge \t{djehuty} }~\\~\\
    { \Large A data and software repository system }~\\~\\
    ~\\~\\
    \url{\djehutygiturl{}}~\\
    version \djehutyversion{}, \today{}
...
\HTMLWrapping{Chapter: Introduction}
\input{introduction}

\HTMLWrapping{Chapter: Configuring Djehuty}
\input{running-djehuty}

\HTMLWrapping{Chapter: Knowledge Graph}
\input{knowledge-graph}

\HTMLWrapping{Chapter: Contributing}
\input{contributing}

\HTMLWrapping{Chapter: Application Programming Interface}
\input{api}

\HTMLWrappingEmptyParagraph
\HTMLWrapping{Chapter: References}
\bibliography{references}

\HTMLWrapping{Chapter: Contact}
\input{contact}

\HTMLWrapping{Chapter: News}
\input{news}
