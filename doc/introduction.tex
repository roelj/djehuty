...
\begin{tabularx}{\textwidth}{*{1}{!{\VRule[-1pt]}l}!{\VRule[-1pt]}X}
  ...
  \href{\djehutygiturl/releases/download/v\djehutyversion/djehuty-\djehutyversion-1.el9.noarch.rpm}%
  {djehuty-\djehutyversion-1.el9.noarch.rpm} & Binary RPM, to install and run \t{djehuty}.\\
  \href{\djehutygiturl/releases/download/v\djehutyversion/djehuty-\djehutyversion-1.el9.src.rpm}%
